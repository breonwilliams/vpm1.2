...
// Non-default animation values.
      ...
      // add new prop to allow element to slide in from below bottom of viewport - K.S.
      ANIM_PROPS_SLIDE_BOTTOM_VPORT = { top: "100vh" },
...
// Not used? Remove?
// NOTE: I think we do need this, I have experienced the animations not working on elements lacking position relative - K.S.
  ...
  for (var itemClass of target.classList) {
    ...
    switch (itemClass) {
      ...
      case LIBRARY_BASE_PREFIX + 'slide-bottom':
        ...
        break;      
      case LIBRARY_BASE_PREFIX + 'slide-bottom-vport':
        $.extend(rtn, ANIM_PROPS_SLIDE_BOTTOM_VPORT);
        break;
      ...
      case LIBRARY_BASE_PREFIX + 'slide-edge-bottom':
        ...
        // added fix so that class slide-edge-bottom seems to work now
        $.extend(rtn, { top: String(distanceToViewportEdge("element_pos", target)) + 'px' });
        break;
